...
- **2026-04-16 — Relocated from Phase 0 to Phase 1.** Frontmatter `phase` field changed from `0` to `1`. Roadmap is now a Phase 1 artifact alongside northstar and mockup, per the concept amendment of the same date that narrowed Phase 0 to concept only and broadened Phase 1 to include illustration and mapping. No body content changes — the roadmap's substance and its relationship to Phase 2 activation are unaffected. _Affects:_ frontmatter only. Upstream: `CONCEPT.md` Phase 0 and Phase 1 bullets.